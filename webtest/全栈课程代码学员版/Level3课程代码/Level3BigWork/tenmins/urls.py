...
from website.views import userdetail, userlogin, usrelist
...
urlpatterns = [
    url(r'^m/userlistpanel/login/$', userlogin, name='userlogin'),
    url(r'^m/userlistpanel/$', usrelist, name='usrelist'),
    url(r'^m/userdetail/$', userdetail, name='userdetail'),

    url(r'^api/oneuser/(?P<id>\d+)$', oneuser),
    url(r'^api/modifyinfo/(?P<id>\d+)$', modifyinfo),

    url(r'^api/getuser/$', getuser),
    url(r'^api/createuser/$', createuser),

    url(r'^api/delete/(?P<id>\d+)$', delete),
    url(r'^api/modifyauth/(?P<id>\d+)$', modifyauth),
