...
class UserProfile(models.Model):
    ...
    nickname = models.CharField(max_length=100,default='maomao')
    profile_image = models.FileField(upload_to='profile_image',default="profile_image/elyse.png")
    NormalOrAuth = (
        ('author', 'author'),
        ('normal', 'normal'),
    )
    choices = models.CharField(choices=NormalOrAuth, max_length=10, default="normal")
